...
public class ReporteVentasController {
	...
	public ResponseEntity<Resource> download(@RequestParam Map<String, Object> params)
        ...
        @GetMapping(path = "/ventas/download1")
	public ResponseEntity<Resource> download1(@RequestParam Map<String, Object> params)
			throws JRException, IOException, SQLException {
		ReporteVentasDTO dto = (ReporteVentasDTO) reporteVentasServiceAPI.obtenerReporteProductos(params);
	...
	public ResponseEntity<Resource> download2(@RequestParam Map<String, Object> params)
			throws JRException, IOException, SQLException {
		ReporteVentasDTO dto = (ReporteVentasDTO) reporteVentasServiceAPI.obtenerReporteVenta(params);
